...
CREATE TABLE MATCHES_TO_PREDICT (
HLTV_LINK VARCHAR(512) NOT NULL,
...
MAP4 VARCHAR(100),
MAP5 VARCHAR(100),
ANCIENT DECIMAL(10, 5),
MIRAGE DECIMAL(10, 5),
INFERNO DECIMAL(10, 5),
NUKE DECIMAL(10, 5),
VERTIGO DECIMAL(10, 5),
DUST2 DECIMAL(10, 5),
OVERPASS DECIMAL(10, 5)
);


ALTER TABLE MATCHES_TO_PREDICT
ADD CONSTRAINT PK_MATCHES_TO_PREDICT PRIMARY KEY (HLTV_LINK);